# 开源版本体已归档于v1.2.3。请参照《主题适配经验指南》自行更新适配。

<br> 

# [V2.0项目网页](https://imtheme.cn)
(更新以项目网页为准)
<br>

<br><br>
> 【更新】📢本项目唯一更新通知频道：https://t.me/+D2y5GDOB8F41YmRl
> 
<br>
...
# 必看说明
- 基于 `Themebox(兼容1.1.1以上）` 主题盒子插件和微信 `8.0.54`及以上版本适配。（其他主题插件、微信版本使用不保证兼容性，请自行调整优化）
- DIY可使用`任意其他作者主题`，但推荐使用`官方测试原生主题`，线上版关注兑换码发放。
...
> 使用`Themebox`兑换码兑换的请直接通过`Themebox`-右上方的`空投箱`下载。
...
> - (部分素材可能涉及版权问题，仅供素材学习交流，免费分享，二次打包请注意)
...
更多更新的**转账卡组**请前往[卡组故事](https://www.imtheme.site/card-story)查看。
...
# 致谢和合作者
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 这期间经历了了解 `Assets` 文件的解包、图标的命名、主题插件的区别、`WeChat` 版本的差异、为什么图标不生效、尺寸适配问题、官方命名和主题插件制作者们的命名方式的区别、熬夜改图、作图、收到很多帮助、讲解和鼓励等等过程。<br>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 这份主题还存在很多待完善和优化的地方，会不断维护和更新的直到哪天完全不能自定义了。
